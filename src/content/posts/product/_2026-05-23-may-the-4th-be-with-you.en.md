...
category: product
tags: ["star-wars", "star-wars-day", "tech", "products"]
lang: en
tldr: "A brief introduction to Star Wars Day"
description: "Learn about the celebration of Star Wars Day"
...
sequenceDiagram
    ...
    Note over User,Browser: User visits the webpage
    User->>Browser: Sends request
    Browser->>Server: Requests webpage content
