...
```mermaid
graph LR
    A[Youth] -->|"Facing pressure and expectations"| B[Inner Rebellion and Social Anxiety]
    B -->|"Conflicting mindsets"| C[Rebellion Against Internalized Pressures]
    B -->|"Conflicting mindsets"| D[Social Anxiety]
    C -->|"Pursuing individual freedom and autonomy"| E[Personal Growth and Development]
    D -->|"Constant striving and struggling"| F[Social Recognition and Success]
```
