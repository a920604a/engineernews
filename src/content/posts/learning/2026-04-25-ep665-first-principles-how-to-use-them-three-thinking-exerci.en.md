...
draft: false
key_points:
  - "When you hit a problem, don't reach for a solution first — step back and ask 'what is the root problem I'm actually trying to solve?'"
  - "Break a decision into three layers — fact / inference / assumption — and the most common failure is an unverified underlying assumption"
  - "When making a choice, start from 'what do I need,' not 'what does the market recommend most'"
tldr: "The concept of first principles isn't hard; actually applying it is. Using three familiar scenarios — the PMP exam, going to grad school, and learning personal finance — Joe from Dadu (大人學) demonstrates three thinking exercises you can turn into daily intuition."
description: "Many people have heard of first principles yet can't put them to use. This piece distills an episode of Dadu's Small Talk into three concrete exercises that turn 'getting back to essence' from a slogan into a thinking habit you can use every day."
audio_url: "/api/tts/r2/tts/tts_20260710_003452_508650.mp3"
---
...
```mermaid
graph TD
    A[Hit a problem / face a choice] --> B[Exercise 1<br/>What problem am I actually solving?]
    B --> C[Exercise 2<br/>What assumptions are hidden underneath?<br/>Fact / Inference / Assumption]
    C --> D[Exercise 3<br/>Start from my needs<br/>not from what the market offers]
    D --> E[A decision that goes straight to the core problem]
```
