DELETE FROM posts WHERE slug='2026-06-15-ep680-haovoice-small-talk' AND id!='learning/2026-06-15-ep680-haovoice-small-talk';

INSERT INTO posts (id, slug, title, category, lang, description, tldr, content, tags, content_hash, created_at, updated_at, audio_url)
VALUES ('learning/2026-06-15-ep680-haovoice-small-talk','2026-06-15-ep680-haovoice-small-talk','書買了沒看完很內疚？郝旭烈：重點不是讀完，而是放自己一馬','learning','zh-TW',
        '郝旭烈在《大人的 Small Talk》談讀書焦慮：買了沒看完不是罪，重點是找到書跟自己的連結。整理他的略覽法、四一讀書法與輸出分享心法。','在《大人的 Small Talk》裡，財經作家郝旭烈分享他的閱讀心法：放自己一馬，不必讀完整本書；用 5～10 分鐘略覽快速擷取重點，再靠『四一讀書法』與分享，把書變成會長大的複利。','
...
- 郝旭烈《郝會讀書》（三采文化）
','["reading","learning","personal-growth","study-methods"]','188bf96a68f4385a6eff283b2ee68b7072a69a644b67d17180476b676450f90a',
...
DELETE FROM doc_chunks WHERE source_id='learning/2026-06-15-ep680-haovoice-small-talk' AND source_type='post';

INSERT INTO doc_chunks (id, source_id, source_type, chunk_index, content, updated_at)
VALUES ('post:4a93e9f046fbf666-0','learning/2026-06-15-ep680-haovoice-small-talk','post',0,'書櫃上有一半的書，買回來根本沒翻過——這幾乎是每個愛買書的人的共同罪惡感。在這集《大人的 Small Talk》裡，主持人 Bryan 找來老朋友、財經作家郝旭烈（郝哥）聊這件事。郝哥今年累積出到第 11 本書，最新一本跟三采合作的《郝會讀書》，談的不是讀書考試，而是怎麼擷取書裡的知識來影響自己的生活。
...
他的略覽順序很簡單，跟《原子習慣》一樣沒壓力，看四個地方：','2026-07-08')
ON CONFLICT(id) DO UPDATE SET content=excluded.content, updated_at=excluded.updated_at;

INSERT INTO doc_chunks (id, source_id, source_type, chunk_index, content, updated_at)
VALUES ('post:4a93e9f046fbf666-1','learning/2026-06-15-ep680-haovoice-small-talk','post',1,'1. **封面與封底**——現在出版社和編輯很用心，最精華的亮點通常都濃縮在封面封底了。
2. **推薦序與自序**——這是作者本人和他的好朋友看完後咀嚼出來的精華，等於替你預先消化過。
3. **目錄**——看過前兩項後，你心裡已經有概念，再從目錄裡挑出你有興趣的那幾個重點。
4. **跳到吸引你的那一頁**——直接翻過去，重點不是記大道理（道理不容易記久），而是找裡面的**小故事**。故事帶著道理，你才帶得走。
...
兩人都很有感的一點是：逛實體書店帶來的好處很難量化。在網路上不管是短影音還是搜尋，內容都被演算法推送；但走進書店、或在鞋櫃旁放一本沒看過的書，多了一個數位時代缺乏的東西——**隨機**。','2026-07-08')
ON CONFLICT(id) DO UPDATE SET content=excluded.content, updated_at=excluded.updated_at;

INSERT INTO doc_chunks (id, source_id, source_type, chunk_index, content, updated_at)
VALUES ('post:4a93e9f046fbf666-2','learning/2026-06-15-ep680-haovoice-small-talk','post',2,'郝哥說這是一種「隨緣」的遇見。他上個月在書店看到一本教做吐司麵包的書，本來毫無興趣，翻開卻看得津津有味；另一本《一個人逃亡的溫泉》，真正吸引他的反而是書裡每個溫泉附的餐點介紹。Bryan 則把逛書店比喻成《星際效應》裡的四維空間——電子書是一個「點」，你要看哪本就叫出哪本；逛書店則像展開了一整個維度，各種你沒想過的書在你面前飄來飄去，把你拉進新世界。
...
郝哥把買書的痛苦歸納成「四大苦」：買了沒看是一苦、放上書架忘了是一苦、送人但對方未必喜歡又是一苦、越積越多佔空間還是一苦。這四苦的共同根源，都是**沒有連結**。','2026-07-08')
ON CONFLICT(id) DO UPDATE SET content=excluded.content, updated_at=excluded.updated_at;

INSERT INTO doc_chunks (id, source_id, source_type, chunk_index, content, updated_at)
VALUES ('post:4a93e9f046fbf666-3','learning/2026-06-15-ep680-haovoice-small-talk','post',3,'化解的關鍵，除了前面說的「不用全部看完」，還有一個更重要的動作——**輸出**。看書是輸入，真正的關鍵是輸出，而輸出最簡單的形式就是**分享**。你不必像郝哥一樣去錄 Podcast、寫書，只要跟家人吃飯時說一句「我今天在書裡看到一個故事蠻有意思的」，就把這本書的好帶出去了。
